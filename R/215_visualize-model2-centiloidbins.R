...
engage_adnimem_results <-    readRDS(here::here("R_objects", "210_engage_adnimem.RDS"))$pe %>% as.data.frame()
engage_adnief_results <-     readRDS(here::here("R_objects", "210_engage_adnief.RDS"))$pe     %>% as.data.frame()
engage_adas13_results <-   readRDS(here::here("R_objects", "210_engage_adas13.RDS"))$pe       %>% as.data.frame()
donanemab_adnimem_results <- readRDS(here::here("R_objects", "210_donanemab_adnimem.RDS"))$pe %>% as.data.frame()
donanemab_adnief_results <- readRDS(here::here("R_objects", "210_donanemab_adnief.RDS"))$pe   %>% as.data.frame()
donanemab_adas13_results <-  readRDS(here::here("R_objects", "210_donanemab_adas13.RDS"))$pe  %>% as.data.frame()
shouldbe_adnimem_results <-  readRDS(here::here("R_objects", "210_shouldbe_adnimem.RDS"))$pe  %>% as.data.frame()
shouldbe_adnief_results <-   readRDS(here::here("R_objects", "210_shouldbe_adnief.RDS"))$pe   %>% as.data.frame()
shouldbe_adas13_results <-   readRDS(here::here("R_objects", "210_shouldbe_adas13.RDS"))$pe   %>% as.data.frame()
